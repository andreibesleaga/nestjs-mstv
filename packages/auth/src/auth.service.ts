...
export class AuthService {
  ...
  private jwtSecret(): string { return process.env.JWT_SECRET || 'changeme'; }
  private accessExp(): string { return process.env.ACCESS_TOKEN_EXP || '15m'; }
  private refreshExpDays() { return parseInt(process.env.REFRESH_TOKEN_EXP?.replace('d','') || '7'); }
